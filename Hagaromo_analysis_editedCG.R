...
##This script was written to read an Excel sheet. 
#read in your file and specific sheet
#read in your file: make sure that you have changed the sheet name and column name so it 
#doesn't have spaces and column names match those in the function)

##Draw plot of just CG large area data. 
...
##to get graphs for Small area data, go to line 204
...
return(hag_plot)
hag_plot
ggsave("/Users/goocam21/Desktop/Hagaromo/mm2xSLTBCG.pdf", width = 6, height = 4, dpi = 300)}
```
...
```{r stuff}
##Draw plot of Small Area MC Density, CG then Combined data
...
##Draw plot of Small Area MC Density Combined data
